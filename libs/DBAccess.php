...
class DBAccess {
    ...
    static private $_DBPASS = _DB_PASSWORD_;
    ...
    static function querySelect($tableName, $arrCon = false, $arrFields = "*", $sort = array(), $sortBy = "A", $lStart = 0, $numRecs = 0, $status = array(_ACTIVE_, _INACTIVE_)) {
